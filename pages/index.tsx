        ...
        <section >
          ...
          <div className='md:flex md:flex-wrap  gap-10 justify-center'>
            ...
            <div className=' text-center p-10 text-gray-700 font-lobster shadow-lg rounded-xl my-8 md:w-5/12 dark:text-white dark:bg-dcardbg hover:-translate-y-2'>
              ...
              <p className='text-lg py-1 md:text-xl'>Implemented cloud memories where user can store their secret notes. They can create their secret notes, able to
                update and delete it and no other users can access it.</p>
